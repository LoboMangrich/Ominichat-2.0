...
const NAV_MODULES: NavModule[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Star,           label: "Leads",                path: "/customers?view=leads", soon: true },
      ...
      { icon: Bell,           label: "Follow-ups",           path: "/customers?view=followups", soon: true },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: LineChart,       label: "Relatórios",          path: "/indicators/health?view=reports", soon: true },
      { icon: Target,          label: "Metas",               path: "/indicators/health?view=metas", soon: true },
      { icon: Users,           label: "Performance da Equipe", path: "/indicators/health?view=team", soon: true },
      { icon: Clock,           label: "ANS",                 path: "/indicators/health?view=sla", soon: true },
      { icon: BarChart3,       label: "Produtividade",       path: "/indicators/health?view=produtividade", soon: true },
