...
const NAV_MODULES: NavModule[] = [
  {
    ...
    items: [
      ...
      { icon: Bot,            label: "Conversas (Sara)",     path: "/sara", sectionHeader: "Atendimento via Sara" },
      // ── Canal próprio ──
      ...
      { icon: Inbox,          label: "Conversas",            path: "/atendimentos", badge: "live", sectionHeader: "Canal próprio" },
